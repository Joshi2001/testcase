...
import 'package:testcase/respository/socket_respository.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) => SocketRepository(context),
        child: Scaffold(
            ...
            body: Consumer<SocketRepository>(
                builder: (context, socketRespository, child) {
              return Column(
                children: [
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final formattedTime =
                            message.timestamp.day == DateTime.now().day
                                ? DateFormat('HH:mm').format(message.timestamp)
                                : DateFormat('MMM dd, HH:mm')
                                    .format(message.timestamp);
                        return Padding(
                          padding: const EdgeInsets.only(
                              left: 24.0, right: 24.0, top: 30),
                          child: Row(
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              onSubmitted: (text) {
                                _sendMessage(socketRespository);
                              },
  ...
  void _sendMessage(SocketRepository socketRespository) {
